...
const cases = [
  {
    ...
    expectedSourceIncludesAfterApply: ['def soma(a, b):', 'def listar(itens):', '# Orquestra o comportamento principal de soma'],
  },
  {
  ...
  },
  {
    ...
    expectedKinds: ['function_doc'],
    expectedSnippetIncludes: ['# Orquestra o comportamento principal de normalizar', '#   value (int):', '#   escala (int):'],
    applyKinds: ['function_doc'],
    mustClearKinds: ['function_doc'],
    expectedSourceIncludesAfterApply: ['# Orquestra o comportamento principal de normalizar', 'def normalizar('],
    forbiddenKinds: ['undefined_variable'],
    forbiddenSnippetIncludes: ['pingu - correction'],
  },
  {
    ...
    expectedSnippetIncludes: ['Representa a responsabilidade principal de Pedido.'],
    applyKinds: ['class_doc'],
    mustClearKinds: ['class_doc'],
    expectedSourceIncludesAfterApply: ['class Pedido:', 'Representa a responsabilidade principal de Pedido.'],
  },
  {
    ...
    expectedSnippetIncludes: ['Calcula total para suportar o restante do fluxo.'],
    applyKinds: ['flow_comment'],
    mustClearKinds: ['flow_comment'],
    expectedSourceIncludesAfterApply: ['# Calcula total para suportar o restante do fluxo.', 'total = valor + 1'],
  },
  {
