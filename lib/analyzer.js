...
function analyzeText(filePath, text, opts = {}) {
  ...
  if (isStructuredTextKind(analyzedKind)) {
    ...
    issues.push(
      ...
      ...checkCommentTask(lines, analyzedFile, { focusRange }),
      ...checkSyntaxIssues(lines, analyzedFile, analyzedKind),
      ...
      ...checkTrailingWhitespace(lines, analyzedFile),
      ...checkTabs(lines, analyzedFile),
      ...(shouldAnalyzeDocumentation ? checkFunctionDocs(lines, analyzedFile, { focusRange: documentationFocusRange }) : []),
      ...(shouldAnalyzeDocumentation ? checkCrossLanguageFunctionDocs(lines, analyzedFile, { focusRange: documentationFocusRange }) : []),
      ...(shouldAnalyzeDocumentation ? checkClassDocs(lines, analyzedFile, { focusRange: documentationFocusRange }) : []),
      ...(shouldAnalyzeDocumentation && runLightAnalysisDeepPass ? checkVariableDocs(lines, analyzedFile, { focusRange: documentationFocusRange }) : []),
      ...(shouldAnalyzeDocumentation && runLightAnalysisDeepPass ? checkFlowMaintenanceComments(lines, analyzedFile, { focusRange: documentationFocusRange }) : []),
