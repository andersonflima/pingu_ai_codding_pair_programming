...
function inferImplicitFunctionParams(name, instruction) {
  ...
  if (/\b(soma|somar|sum|add|adicao|adição|subtracao|subtração|subtrair|subtract|multiplicacao|multiplicação|multiplicar|multiply|divisao|divisão|dividir|divide)\b/.test(arithmeticContext)) {
    return ['a', 'b'];
  }
