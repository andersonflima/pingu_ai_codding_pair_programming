...
const LANGUAGE_CAPABILITY_REGISTRY = Object.freeze([
  ...
  },
  {
    ...
    unitTestStyle: 'native',
    structured: false,
    editorFeatures: ['comment_task', 'unit_test', 'terminal_task'],
    commentTaskIntents: ['function', 'crud', 'test', 'comment', 'enum', 'class', 'interface', 'struct', 'module', 'object', 'collection', 'variable'],
    offlineCapabilities: ['simple_function', 'arithmetic_function', 'literal_return', 'dice_roll', 'crud_scaffold', 'unit_test_generation', 'terminal_task'],
    bestPractices: [
  ...
  },
  {
    ...
    editorFeatures: ['comment_task', 'unit_test', 'terminal_task'],
    commentTaskIntents: ['function', 'crud', 'test', 'comment', 'enum', 'class', 'interface', 'struct', 'module', 'object', 'collection', 'variable'],
    offlineCapabilities: ['simple_function', 'arithmetic_function', 'literal_return', 'dice_roll', 'crud_scaffold', 'unit_test_generation', 'terminal_task', 'module_wrap'],
    bestPractices: [
  ...
  },
  {
    ...
    offlineCapabilities: ['simple_function', 'arithmetic_function', 'literal_return', 'crud_scaffold', 'unit_test_generation', 'terminal_task'],
    bestPractices: [
  ...
  },
  {
    ...
    offlineCapabilities: ['simple_function', 'arithmetic_function', 'literal_return', 'unit_test_generation', 'terminal_task'],
    bestPractices: [
  ...
  },
  {
    ...
    offlineCapabilities: ['simple_function', 'arithmetic_function', 'literal_return', 'dice_roll', 'unit_test_generation', 'terminal_task'],
    bestPractices: [
  ...
  },
  {
    ...
    unitTestStyle: 'contract',
    structured: true,
    editorFeatures: ['comment_task', 'context_file', 'unit_test'],
    commentTaskIntents: ['document', 'context_blueprint'],
    offlineCapabilities: ['document_generation', 'contract_test_generation', 'context_blueprint'],
    bestPractices: [
  ...
  },
  {
    ...
    offlineCapabilities: ['diagram_generation', 'contract_test_generation', 'context_blueprint'],
    bestPractices: [
  ...
  },
  {
    ...
    offlineCapabilities: ['workdir_generation', 'contract_test_generation', 'terminal_task'],
    bestPractices: [
  ...
  },
  {
    ...
    offlineCapabilities: ['simple_function', 'arithmetic_function', 'literal_return', 'terminal_task', 'simple_script'],
    bestPractices: [
  ...
  },
  {
    ...
    unitTestStyle: 'none',
    structured: true,
    editorFeatures: ['comment_task', 'context_file'],
    commentTaskIntents: ['config', 'section', 'context_blueprint'],
    offlineCapabilities: ['comment_task', 'context_blueprint'],
    bestPractices: [
...
function getCapabilityProfile(fileOrExt) {
  ...
  return EXTENSION_TO_CAPABILITY.get(extension) || LANGUAGE_CAPABILITY_REGISTRY[LANGUAGE_CAPABILITY_REGISTRY.length - 1];
}
...
function languageCapabilityRegistry() {
  return LANGUAGE_CAPABILITY_REGISTRY.map((entry) => ({
    ...entry,
